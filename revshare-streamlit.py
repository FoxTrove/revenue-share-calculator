...
expected_monthly_revenue = st.number_input("Expected monthly revenue ($)", min_value=0.0, value=15000.0, step=100.0)
revenue_threshold = st.number_input("Revenue threshold ($)", min_value=0.0, value=50000.0, step=100.0)
